...
#define LINEAR_REGRESSION_ARRAY_SIZE 30

struct minstrel_rate_prediction
{
	int time[LINEAR_REGRESSION_ARRAY_SIZE];
	int probs[LINEAR_REGRESSION_ARRAY_SIZE];
	int lrIndex;
};
...
int minstrel_ht_get_tp_avg(struct minstrel_ht_sta *mi, int group, int rate,
			   int prob_avg);
void rate_prediction_init(void);
